...
<head>
    ...
    <style>
        /* =====================================================
           ...
           Page 1 mirrors the international (875) layout — asset
           allocation with change arrows, geographic exposure,
           sector bars, four-series performance chart — while the
           sidebar and page 2 follow the SA fact sheets (FEE RATES,
           TOTAL INVESTMENT CHARGE, INVESTING OFFSHORE).
           ===================================================== */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .perf-table th:nth-child(2) { width: 12%; }
        .perf-table th:nth-child(3) { width: 10.7%; }
        .perf-table td {
            color: #000;
            font-size: 7.5pt;
            line-height: 8pt;
                ...
                <div class="sidebar">
                    @if(isset($fund->data['sidebar']))
                        @php
                            ...
                            // Feeder sidebar per the published 809 fact sheets.
                            ...
                            $displayOrder = [
                                ...
                                'category', 'minimums', 'portfolioSize', 'unitPrice',
