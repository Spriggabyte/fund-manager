                    ...
                    <div class="mb-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full border-collapse">
                                ...
                                @php
                                    $aaHeaders = $data['mainContent']['assetAllocation']['headers'] ?? [];
                                    $aaColumnKeys = [];
                                ...
                                <tbody>
                                    ...
                                    @endforeach
                                    @if(isset($data['mainContent']['assetAllocation']['total']))
                                        @php $aaTotal = $data['mainContent']['assetAllocation']['total']; @endphp
