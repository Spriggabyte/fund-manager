                ...
                @if(isset($fund->data['mainContent']['charts']['maturityData']))
                    ...
                    <div class="maturity-section">
                        ...
                        @if(!empty($maturity['subtitle']))
                            <p class="section-subheading"><span x-data="editableField('mainContent.charts.maturityData.subtitle', '{{ addslashes($maturity['subtitle']) }}')" @click="editMode && startEdit()" :class="editMode ? 'editable' : ''">{{ $maturity['subtitle'] }}</span></p>
                        @endif
