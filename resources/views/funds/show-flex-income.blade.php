                        ...
                        <div class="table-container structure-table">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    @endif
                                    @if(isset($structure['foreignCurrencyHedge']))
                                    ...
                                    @endif
                                    @if(isset($structure['foreignCurrencyExposure']))
                        ...
                        @if($credit)
                            <div class="credit-block">
                                ...
                                <div class="credit-tables">
                                    @foreach ([['RATING<sup>4</sup>', 'ratings', $creditRatings], ['SECTOR', 'sectors', $creditSectors]] as [$creditHeading, $creditKey, $creditRows])
                ...
                @if(isset($fund->data['mainContent']['performanceTable']))
                    ...
                    <div class="table-container performance-table">
                        <table>
                            ...
                            <tbody>
                                {{-- Flex income display rules (per the signed-off 824 reference
                                     PDF, mirrored in pdf-flex-income.blade.php): the import writes
                                     raw row names (Fund, Benchmark, Fund highest/lowest). Display
                                     order puts a blank spacer before the highest/lowest rows.
                                     Footnotes: Fund⁷, highest/lowest⁷,⁸; Benchmark has no marker. --}}
                                @php
