...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* =====================================================
           FLEX INCOME PAGE 1 — portfolio structure, statistics,
           maturity spread, credit exposure
           (824 reference: Foord Flex Income Fund Class A at 2026-03-31)
           ===================================================== */
                        ...
                        @if($credit)
                            <div class="credit-block">
                                ...
                                <div class="credit-tables">
                                    @foreach ([['RATING<sup>4</sup>', $creditRatings, 'ratings'], ['SECTOR', $creditSectors, 'sectors']] as [$creditHeading, $creditRows, $creditKey])
                        ...
                        @if(isset($fund->data['mainContent']['charts']['portfolioData']))
                            <div class="portfolio-chart-block">
                                ...
                                <div class="chart-wrapper">
                                    <div class="chart-ytitle">Cash Value<sup>5</sup> (R&rsquo;000)</div>
