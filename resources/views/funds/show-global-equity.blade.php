...
<head>
    ...
    <style>
        /* =====================================================
           ...
           Cloned from show-international.blade.php (the 875 print
           layout) and re-gridded per the 877 Class R reference:
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-section { margin-bottom: 0.55mm; }
        ...
        /* =====================================================
           ...
           ===================================================== */
        .ps-section { margin-bottom: 3.3mm; }
        ...
        .ps-header .ps-header-change { width: 26mm; }
        .ps-header .ps-header-variance { width: 30mm; }
        ...
        .pfe-table .foord-table th { font-size: 6.5pt; }
...
<body class="@if(request()->has('pdf')) pdf-mode @endif" x-data="fundEditor()">
                    ...
                    @if(isset($fund->data['sidebar']))
                        @php
                            ...
                            $displayOrder = [
                                ...
                                'depository', 'investmentManager', 'subInvestmentManager', 'fundManagers',
                            ...
                            @if(isset($sidebar[$key]))
                                ...
                                @if ($key === 'equityIndicator' && is_array($value))
                                    <div class="sidebar-section">
                                        @php
                                            /* 877 reference: nine of ten dots filled */
                    ...
                    @if(!empty($fund->data['mainContent']['sectorAllocation']['sectors']))
                        ...
                        <div class="ps-section">
                            <div class="ps-header">
                                ...
                                <div class="ps-header-col ps-header-variance">Variance to<br>MSCI ACWI<sup>6</sup></div>
                            </div>
                            <div>
                                @foreach ($psSectors as $rowIndex => $row)
                                    ...
                                    <div class="ps-row">
                                        ...
                                        <div class="ps-bar-container">
                                            <div class="{{ $barClass }}" style="width: {{ round((float) ($row['value'] ?? 0) / $psMax * 98, 1) }}%;"></div>
                                        </div>
                                        <span class="ps-value">
    ...
    <script>
        ...
        // End value annotation plugin ($ 397 / $ 288 / $ 228 per the
        // 877 reference)
