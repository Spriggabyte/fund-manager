...
<head>
    ...
    <style>
        ...
        /* Flex income page 1 — portfolio structure, statistics, maturity
           spread, credit exposure (mirrors pdf-flex-income.blade.php) */
        .structure-section { margin-bottom: 3mm; }
        .structure-table table th:first-child,
        .structure-table table td:first-child { width: 40%; }
        .structure-table table tr.fx-hedge-row td {
            background-color: var(--white);
            font-weight: 500;
        }
        .structure-table table tr.fx-exposure-row td {
            background-color: var(--naartjie);
            color: var(--white);
            font-weight: 500;
        }
        ...
        .p1-footnotes { margin-top: 8mm; }
        .p1-footnotes .footnotes { font-size: 6.84pt; line-height: 8.65pt; color: #000; padding-left: 0; }
        .p1-footnotes .footnotes p { margin: 0; }
        .tic-footnote {
            font-family: 'Avenir Next', 'Lato', sans-serif;
            font-size: 6.53pt;
            line-height: 7.94pt;
        ...
        .shariah-funds-section { margin-top: 10mm; }
        .shariah-funds-section p + p { margin-top: 3.2mm; }
...
<body x-data="fundEditor()">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-content">
                ...
                @if(isset($fund->data['mainContent']['performanceTable']))
                    ...
                    <div class="table-container performance-table">
                        <table>
                            ...
                            <tbody>
                                {{-- 841 display rules (mirrored in pdf-shariah-income.blade.php):
                                     only the Fund and Benchmark rows print. The feed still exports
                                     FOORD_HIGHEST_*/FOORD_LOWEST_*, and older stored revisions may
                                     still carry those rows, so they are filtered out here too.
                                     Footnotes: Fund⁶; Benchmark has no marker. --}}
                                @php
                ...
                {{-- Numbered footnotes print at the bottom of PAGE 1 on the 841
                     reference, below the performance table. --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // The portfolio chart is the cash-value line chart in the exact style of the
