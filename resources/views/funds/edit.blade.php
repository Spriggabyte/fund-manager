                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="template" name="template" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        @foreach (['show' => 'Default', 'show-equity' => 'Equity', 'show-flexible' => 'Flexible', 'show-conservative' => 'Conservative', 'show-bond' => 'Bond', 'show-flex-income' => 'Flex Income', 'show-income' => 'Income', 'show-inflation-income' => 'Inflation Linked Income', 'show-domestic' => 'Domestic Balanced', 'show-absolute' => 'Absolute Return', 'show-shariah' => 'Shariah Balanced', 'show-shariah-income' => 'Shariah Income', 'show-international' => 'International', 'show-international-trust' => 'International Trust', 'show-global-equity' => 'Global Equity (Lux)', 'show-feeder' => 'Feeder', 'show-prescient-feeder' => 'Prescient Feeder', 'show-prescient-global-equity' => 'Prescient Global Equity Feeder', 'show-hassen-shariah' => 'Hassen Shariah Global Equity', 'show-australian-feeder' => 'Global Equity Australian Feeder', 'show-asia-ex-japan' => 'Asia ex-Japan'] as $val => $label)
