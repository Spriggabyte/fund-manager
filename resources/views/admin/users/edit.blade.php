                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                Leave blank to keep the current password. Setting one here makes it temporary — they will be asked to choose their own at next sign-in.
                            </p>
                        </div>
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            ...
                            @else
                                <p class="text-sm text-gray-600">
                                    You cannot change your own admin rights. Ask another administrator if this needs to change.
                                </p>
                            @endcan
                        </div>
